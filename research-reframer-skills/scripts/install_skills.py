#!/usr/bin/env python
"""Install Research Reframer skills into Claude Code or Codex skill folders."""
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Install Research Reframer skills.")
    parser.add_argument(
        "--target",
        choices=[
            "claude",
        ...
        default="both",
        help=(
            "Install target. codex/codex-user use the official ~/.agents/skills "
            "location; legacy-codex uses ~/.codex/skills for older local setups."
        ),
    )
    parser.add_argument(
        "--path",

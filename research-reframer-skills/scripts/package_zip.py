#!/usr/bin/env python
"""Package the Research Reframer skill pack with portable ZIP paths."""
...
DEFAULT_OUT = Path("dist") / "research-reframer-skills-pack.zip"
EXCLUDED_DIRS = set([
    ".git",
    ".pytest_cache",
    "__pycache__",
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Create a portable Research Reframer skill pack ZIP.")

...
在系统结构分析出的“杠杆点”上，进行“非线性”的“研究问题重构”。 科学史上的很多突破往往呈现出某种“反理性”的跃迁，大语言模型基于大量“理性”的严谨因果语料训练而成，其天然的模式识别惯性极易让智能体在已存在的模式内逐步探索。Frameshift 引入《水平思考》（爱德华·德博诺著）里面介绍的方法，尝试在结构的约束下，给智能体提供一套刻意打破认知代码、重组信息的实用工具。通过主动转换入手点，反转因果方向，拆解隐含假设，跨领域的类比与引入外部强刺激等方式，用“有方向的混乱”和暂缓判断的保护机制，让 AI 尝试生成“全新的问题框架”，而不是渐进增量式的改进。 
...
> 当研究人员使用传统的科学Idea生成流程总是得不到想要的研究方向

的时候：

> 使用Frameshift可以帮助他们找到一些有趣的平时不容易想到的研究方案

---
## 当前进度

Frameshift目前已经搭成了基本框架，但目前测试的效果还有待改进。后续将继续改进提示词设计和优化结构达到设定的目标。

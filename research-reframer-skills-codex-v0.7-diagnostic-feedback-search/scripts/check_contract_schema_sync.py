...
SCHEMA_KEYS = {
    "stage0_diagnosis.schema.json": ["diagnosis"],
    "system_map.schema.json": [
        "system_map", "system_map_actor", "system_map_goal", "system_map_stock",
        "system_map_flow", "system_map_feedback_loop", "system_map_rule",
        "system_map_information_flow", "system_map_delay", "system_map_boundary",
        "system_map_failure_mode", "system_map_uncertainty", "system_map_relation_audit",
    ],
    ...
    "vertical_audits.schema.json": [
        "vertical_audits", "vertical_audit_item", "vertical_audit_merge",
        "pseudo_innovation", "audit_score",
    ],
    "gate_cards.schema.json": ["gate_cards", "gate_cards_gate", "gate_card_item", "gate_card_row"],
    "human_selection.schema.json": [
        "human_selection", "human_selection_gate", "human_selection_gate3_item",
    ],
    "idea_cards.schema.json": [
        "idea_cards", "idea_card_item", "idea_card_system_trace",
        "idea_card_method_trace", "idea_card_reader_view", "idea_card_change_log", "audit_score",
    ],
}
